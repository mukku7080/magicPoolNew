...
const CongratulationsModal = ({ isOpen, onClose, email, password, mycode }) => {
  ...
  const { onCopy: copyUserId, hasCopied: mycodeCopied } = useClipboard(mycode);
        ...
        <ModalBody>
          ...
          >
            ...
            <Flex justify="space-between" align="center" mb={2}>
              ...
              <Flex align="center" gap={2}>
                <Text fontSize="sm" color="gray.700">{mycode}</Text>
                <IconButton
                  size="sm"
                  icon={<CopyIcon />}
                  onClick={copyUserId}
