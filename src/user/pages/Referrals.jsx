...
const Referrals = () => {
    ...
    const shareViaMethod = (method) => {
        const message = `Join Magic Auto Pool and start earning! Use my referral link: ${referralLink}`;
        ...
        switch (method) {
            case 'whatsapp':
                ...
                break;
            case 'telegram':
                window.open(`https://t.me/share/url?url=${encodeURIComponent(referralLink)}&text=${encodeURIComponent('Join Magic Auto pool and start earning!')}`, '_blank');
                break;
            case 'twitter':
                ...
                <VStack spacing={8}>
                    ...
                    <VStack spacing={4} textAlign="center">
                        ...
                        <Text fontSize="lg" color="gray.600" maxW="2xl">
                            Earn rewards by inviting friends to join Magic Auto pool. Share your unique referral link and get rewarded for every successful signup!
                        </Text>
